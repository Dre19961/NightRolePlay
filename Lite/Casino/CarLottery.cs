...
namespace Lite.Casino
{
    class CarLottery : Script
    {
        ...
        private static int _price = 10000000;
        ...
        public static void CallBackShape(Player player)
        {
            ...
            Trigger.ClientEvent(player, "openDialog", "RANDOMMEMBER_ADD",
                $"Сегодня разыгрывается {VehicleHandlers.VehiclesName.GetRealVehicleName(vModel)}. При выигрыше автомобиль доставят вам в гараж. Стоимость участия: {_price}$. Учавствовать?");
        }
