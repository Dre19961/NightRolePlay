...
namespace Lite.Fractions
{
    ...
    { // Revision 3.0
        ...
        public static void onResourceStart()
        {
            try
            {
                NAPI.Blip.CreateBlip(590, new Vector3(-589.7050170898438, -928.1387329101562, 23.87757682800293), 0.8f, 1, Main.StringToU16("Weazel News"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(419, Cityhall.CityhallChecksCoords[2], 0.8f, 4, Main.StringToU16("Government"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(61, Manager.FractionSpawns[8], 0.8f, 1, Main.StringToU16("Больница"), 255, 0, true, 0);
                NAPI.Blip.CreateBlip(88, Fbi.EnterFBI, 0.8f, 58, Main.StringToU16("FIB"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(526, Police.policeCheckpoints[1], 0.8f, 38, Main.StringToU16("LSPD"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(85, Army.ArmyCheckpoints[2], 0.8f, 28, Main.StringToU16("Доки"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(526, Manager.FractionSpawns[18], 0.8f, 47, Main.StringToU16("Sheriff"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(630, Manager.FractionSpawns[1], 0.8f, 52, Main.StringToU16("The Families"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(630, Manager.FractionSpawns[2], 0.8f, 58, Main.StringToU16("The Ballas"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(630, Manager.FractionSpawns[3], 0.8f, 28, Main.StringToU16("Los Santos Vagos"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(630, Manager.FractionSpawns[4], 0.8f, 74, Main.StringToU16("Marabunta Grande"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(630, Manager.FractionSpawns[5], 0.8f, 49, Main.StringToU16("Blood Street"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[10], 0.8f, 5, Main.StringToU16("La Cosa Nostra"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[11], 0.8f, 4, Main.StringToU16("Русская мафия"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[12], 0.8f, 76, Main.StringToU16("Yakuza"), 255, 0, true, 0, 0);
                NAPI.Blip.CreateBlip(78, Manager.FractionSpawns[13], 0.8f, 40, Main.StringToU16("Армянская мафия"), 255, 0, true, 0, 0);

                NAPI.Blip.CreateBlip(267, new Vector3(219.48419, -801.5308, 29.6229), 0.8f, 1, Main.StringToU16("Штрафстоянка"), 255, 0, true, 0);
                NAPI.Blip.CreateBlip(409, new Vector3(-815.4488, -1346.8057, 5.1302644), 0.8f, 5, Main.StringToU16("Спавн"), 255, 0, true, 0);
                ...
                var shape = NAPI.ColShape.CreateCylinderColShape(new Vector3(-444.14584, -357.93643, 33.47796), 4f, 3, 0);
                var shape2 = NAPI.ColShape.CreateCylinderColShape(new Vector3(-448.1092, -347.98685, 33.38179), 4f, 3, 0);
                var shape3 = NAPI.ColShape.CreateCylinderColShape(new Vector3(-447.26947, -341.03094, 33.38182), 4f, 3, 0);
                var shape4 = NAPI.ColShape.CreateCylinderColShape(new Vector3(-446.15604, -333.744, 33.381847), 4f, 3, 0);
                var shape5 = NAPI.ColShape.CreateCylinderColShape(new Vector3(-438.05746, -341.5371, 41.200672), 4f, 3, 0);
                var shape6 = NAPI.ColShape.CreateCylinderColShape(new Vector3(-473.46335, -341.1638, 41.199223), 4f, 3, 0);
                var shape7 = NAPI.ColShape.CreateCylinderColShape(new Vector3(-472.3523, -332.61276, 41.200684), 4f, 3, 0);
                var shape8 = NAPI.ColShape.CreateCylinderColShape(new Vector3(-507.7385, -332.16898, 41.19978), 4f, 3, 0);
                ...
                shape.OnEntityEnterColShape += (s, entity) =>
                {
                    try
                    {
                        if (entity.HasData("HEAL_TIMER") && NAPI.Player.GetPlayerHealth(entity) < 100)
                        {
                            ...
                            NAPI.Entity.SetEntityPosition(entity, new Vector3(-461.7459, -285.3787, 34.293182));
                        }
                    }
                ...
                shape4.OnEntityEnterColShape += (s, entity) =>
                {
                    try
                    {
                        if (entity.HasData("HEAL_TIMER") && NAPI.Player.GetPlayerHealth(entity) < 100)
                ...
                shape5.OnEntityEnterColShape += (s, entity) =>
                {
                    try
                    {
                        if (entity.HasData("HEAL_TIMER") && NAPI.Player.GetPlayerHealth(entity) < 100)
                ...
                shape6.OnEntityEnterColShape += (s, entity) =>
                {
                    try
                    {
                        if (entity.HasData("HEAL_TIMER") && NAPI.Player.GetPlayerHealth(entity) < 100)
                ...
                shape7.OnEntityEnterColShape += (s, entity) =>
                {
                    try
                    {
                        if (entity.HasData("HEAL_TIMER") && NAPI.Player.GetPlayerHealth(entity) < 100)
                ...
                shape8.OnEntityEnterColShape += (s, entity) =>
                {
                    try
                    {
                        if (entity.HasData("HEAL_TIMER") && NAPI.Player.GetPlayerHealth(entity) < 100)
        ...
        {
             {1, new Vector3(-34.481087, -1402.8026, 29.382404)},    // The Families
            {2, new Vector3(150.66782, -1716.3452, 29.291433)},     // The Ballas Gang
            {3, new Vector3(819.58276, -2325.3508, 30.464808)},     // Los Santos Vagos
            {4, new Vector3(1363.6792, -2096.08, 52.008087)},     // Marabunta Grande
            {5, new Vector3(939.5117, -1557.0542, 31.094168)},     // Blood Street
            {6, new Vector3(-545.2812, -184.93634, 42.70315)},      // Cityhall
            {7, new Vector3(457.92334, -990.4371, 30.689592)},      // LSPD police
            {8, new Vector3(350.9417, -1429.0278, 32.509346)},      // Emergency care
            {9, new Vector3(149.4746, -756.9065, 243.0319)},     // FBI 
            {10, new Vector3(1401.3923, 1139.0846, 109.74566)},     // La Cosa Nostra 
            {11, new Vector3(-115.1648, 983.5231, 236.6358)},    // Russian Mafia
            {12, new Vector3(-1027.362, 306.55923, 66.99369)},    // Yakuza 
            {13, new Vector3(-1530.4545, 136.95703, 55.668392)},    // Armenian Mafia 
            {14, new Vector3(-2355.625, 3254.189, 33.69071)},    // Army
            {15, new Vector3(-568.05597, -909.9288, 22.857114)},    // LSNews
            {16, new Vector3(982.2743, -104.14917, 73.72877)},    // The Lost
            {17, new Vector3(2154.641, 2921.034, -63.02243)},    // Merryweather
            {18, new Vector3(-454.70694, 6015.597, 31.716529)},    // Sheriff
        };
    ...
    class Stocks : Script
    {
        ...
        {
            { 1, new Vector3(-51.368736, -1395.0239, 29.282427)},
            { 2, new Vector3(154.3463, -1713.1572, 25.791409)},
            { 3, new Vector3(811.969, -2312.0496, 30.464754)},
            { 4, new Vector3(1363.3181, -2096.7742, 47.20777)},     // Marabunta Grande
            { 5, new Vector3(930.63336, -1529.3236, 31.11206)},
            { 6, new Vector3()},
            { 7, new Vector3(-1081.6998, -824.58936, 22.918518)},
            { 8, new Vector3()},
            { 9, new Vector3()},
            { 10, new Vector3(1401.3923, 1139.0846, 109.74566)},
            { 11, new Vector3(-78.1424, 1001.9106, 229.40277)},
            { 12, new Vector3(-1045.8291, 302.7253, 62.21717)},
            { 13, new Vector3(-1517.81, 111.92982, 50.054268)},
            { 14, new Vector3()},
            { 15, new Vector3()},
        ...
        public void fillStocks()
        {
            try
            {
                ...
                foreach (DataRow Row in result.Rows)
                {
                    ...
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16($"~w~Склад {Manager.getName(id)}"), new Vector3(stockCoords[id].X, stockCoords[id].Y, stockCoords[id].Z + 0.6), 5F, 0.5F, 0, new Color(227, 252, 252));
                    ...
                    NAPI.Marker.CreateMarker(42, garageCoords[id], new Vector3(), new Vector3(90,0,0), 3f, new Color(129, 159, 235));
                }
            }
