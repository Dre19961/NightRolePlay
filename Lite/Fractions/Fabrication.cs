    ...
    class AlcoFabrication : Script
    {
        ...
        */
        ...
        private static Dictionary<int, Vector3> EnterAlcoShop = new Dictionary<int, Vector3>()
        {
            ...
            { 11, new Vector3(-436.17557, -359.5525, 34.94931) },
        ...
        private static Dictionary<int, Vector3> ExitAlcoShop = new Dictionary<int, Vector3>()
        {
            ...
            { 11, new Vector3(-421.26263, -345.8464, 24.109394) },
        ...
        private static Dictionary<int, Vector3> UnloadPoints = new Dictionary<int, Vector3>()
        {
            ...
            { 11, new Vector3(1057.0415, -2540.1436, 13.924406) },
        ...
        private static Dictionary<int, Vector3> BuyPoints = new Dictionary<int, Vector3>()
        {
            ...
            { 11, new Vector3(4902.342, -4941.2065, 2.2415848) },
        ...
        public void Event_ResourceStart()
        {
            try
            {
                ...
                NAPI.Blip.CreateBlip(93, new Vector3(-1388.761, -586.3921, 29.09945), 0.8f, 0, "Клуб", 255, 0, true);
                NAPI.Blip.CreateBlip(93, new Vector3(141.3792, -1281.576, 28.2172), 0.8f, 0, "Клуб", 255, 0, true);
                NAPI.Blip.CreateBlip(93, new Vector3(-564.5512, 275.6993, 81.98249), 0.8f, 0, "Клуб", 255, 0, true);
                NAPI.Blip.CreateBlip(93, new Vector3(-430.1028, 261.2774, 81.88689), 0.8f, 0, "Клуб", 255, 0, true);
                NAPI.Blip.CreateBlip(93, new Vector3(4893.0127, -4942.0474, 2.239923), 0.8f, 0, "Клуб", 255, 0, true);
                NAPI.Blip.CreateBlip(90, new Vector3(-1057.0415, -2540.1436, 12.804406), 0.8f, 2, "Остров Kayo-Perico", 255, 0, true);
                NAPI.Blip.CreateBlip(90, new Vector3(4842.322, -5174.206, 2.265395), 0.8f, 1, "Los-Santos", 255, 0, true);
                NAPI.Blip.CreateBlip(427, new Vector3(5108.5366, -5198.9604, 3.8563447), 0.8f, 0, "Аренда Лодок", 255, 0, true);
                NAPI.Blip.CreateBlip(572, new Vector3(-2307.9976, 3390.9915, 29.867004), 0.8f, 4, "National Guard", 255, 0, true);
                
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16($"~b~В больницу"), new Vector3(-421.26263, -345.8464, 23.109394 + 0.6), 5F, 0.5F, 0, new Color(227, 252, 252));
                ...
                foreach (var pair in EnterAlcoShop)
                {
                    ...
                    NAPI.Marker.CreateMarker(1, pair.Value - new Vector3(0, 0, 1), new Vector3(), new Vector3(), 1, new Color(129, 159, 235), false, NAPI.GlobalDimension);
                }
                #endregion
                ...
                foreach (var pair in UnloadPoints)
                {
                    ...
                    NAPI.TextLabel.CreateTextLabel($"~w~Выгрузить все материалы", pair.Value + new Vector3(0, 0, 0.5), 5f, 0.3f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                }
                #endregion
                #region BuyPoints
                foreach (var pair in BuyPoints)
                {
                    ...
                    NAPI.Marker.CreateMarker(1, pair.Value - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1, new Color(129, 159, 235), false, NAPI.GlobalDimension);
