...
namespace Lite.Fractions
{
    class Police : Script
    {
        ...
        {
            new Vector3(459.23483, -997.64557, 24.794855),    // Радиус тюрьмы                                  0
            new Vector3(452.45264, -980.1454, 30.069603),     // Оружие                                         1
            new Vector3(458.94485, -992.89545, 30.069588),    // Переодется                                     2
            new Vector3(452.17538, -992.2687, 30.06958),      // ES меню                                        3
            new Vector3(459.23483, -997.64557, 24.794855),    // Тюрьма                                         4 
            new Vector3(446.09665, -983.57324, 30.569584),    // Место освобождения из тюрьмы                   5
            new Vector3(441.8187, -981.6356, 30.0696),        // Покупка лицензии                               6
            new Vector3(439.8187, -981.6356, 30.0696),        // Сдать сумку                                    7
            new Vector3(452.32413, -981.54346, 30.689333),      // Открыть склад                                  8
            new Vector3(454.45972, -1025.0759, 27.85017),     // Улучшение машины                               9
        };
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                Cols.Add(0, NAPI.ColShape.CreateCylinderColShape(policeCheckpoints[0], 4f, 2, 0));
                ...
                Cols.Add(1, NAPI.ColShape.CreateCylinderColShape(policeCheckpoints[1], 0.5f, 2, 0));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Открыть меню"), new Vector3(policeCheckpoints[1].X, policeCheckpoints[1].Y, policeCheckpoints[1].Z + 0.2), 5F, 0.3F, 0, new Color(255, 255, 255));

                Cols.Add(2, NAPI.ColShape.CreateCylinderColShape(policeCheckpoints[2], 0.5f, 2, 0));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Переодеться"), new Vector3(policeCheckpoints[2].X, policeCheckpoints[2].Y, policeCheckpoints[2].Z + 0.2), 5F, 0.3F, 0, new Color(255, 255, 255));

                Cols.Add(3, NAPI.ColShape.CreateCylinderColShape(policeCheckpoints[3], 0.5f, 2, 0));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~ES меню"), new Vector3(policeCheckpoints[3].X, policeCheckpoints[3].Y, policeCheckpoints[3].Z + 0.2), 5F, 0.3F, 0, new Color(255, 255, 255));

                Cols.Add(5, NAPI.ColShape.CreateCylinderColShape(policeCheckpoints[7], 0.5f, 2, 0));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Сдать сумку"), new Vector3(policeCheckpoints[7].X, policeCheckpoints[7].Y, policeCheckpoints[7].Z + 0.2), 5F, 0.3F, 0, new Color(255, 255, 255));

                Cols.Add(6, NAPI.ColShape.CreateCylinderColShape(policeCheckpoints[8], 0.5f, 2, 0));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Склад"), new Vector3(policeCheckpoints[8].X, policeCheckpoints[8].Y, policeCheckpoints[8].Z + 0.2), 5F, 0.3F, 0, new Color(255, 255, 255));

                Cols.Add(7, NAPI.ColShape.CreateCylinderColShape(policeCheckpoints[9], 1.5f, 2, 0));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Улучшение"), new Vector3(policeCheckpoints[9].X, policeCheckpoints[9].Y, policeCheckpoints[9].Z + 0.2), 5F, 0.3F, 0, new Color(255, 255, 255));

                NAPI.Marker.CreateMarker(1, policeCheckpoints[1] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.5f, new Color(129, 159, 235));
                NAPI.Marker.CreateMarker(1, policeCheckpoints[2] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.5f, new Color(129, 159, 235));
                NAPI.Marker.CreateMarker(1, policeCheckpoints[3] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.5f, new Color(129, 159, 235));
                NAPI.Marker.CreateMarker(1, policeCheckpoints[7] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.5f, new Color(129, 159, 235));
                NAPI.Marker.CreateMarker(1, policeCheckpoints[8] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.5f, new Color(129, 159, 235));
                NAPI.Marker.CreateMarker(1, policeCheckpoints[9] - new Vector3(0, 0, 1.5), new Vector3(), new Vector3(), 1.5f, new Color(129, 159, 235));
