...
namespace Lite.Fractions
{
        ...
        private static void DeleteSpawnedCar(Player player, string vnumber)
        {
            ...
            foreach (Vehicle item in NAPI.Pools.GetAllVehicles())
            {
                if (item.NumberPlate == vnumber)
                {
                    ...
                    {
                        if(item.Position.DistanceTo2D(spawner.Position) > 1000000)
                        {
    ...
    public class CarSpawner
    {
        ...
        private void Create()
        {
            shape = NAPI.ColShape.CreateCylinderColShape(Position, 0.5f, 2, 0);
            marker = NAPI.Marker.CreateMarker(1, Position - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1f, new Color(35, 152, 247), false, 0);
            label = NAPI.TextLabel.CreateTextLabel("~w~Спавн транспорта", Position + new Vector3(0, 0, 0.2), 5F, 0.3F, 0, new Color(255, 255, 255), false, 0);
        ...
        public static void Init()
        {
            ...
            {
                { 1, new Vector3(9.388264, -1403.2274, 29.280571)}, //Families
                { 2, new Vector3(170.33958, -1722.4863, 29.391651)}, //Ballas
                { 3, new Vector3(838.5245, -2363.1655, 30.352716)}, //Vagos
                { 4, new Vector3(1373.526, -2084.1714, 51.996573)}, //Marabunte
                { 5, new Vector3(913.73, -1542.6027, 30.68321)}, //Bloods
                { 6, new Vector3(-560.6294, -174.94687, 38.178725)}, //CityHall
                { 7, new Vector3(408.09616, -979.99097, 28.648275)}, //Police
                { 8, new Vector3(373.7048, -1442.1621, 28.501492)}, //EMS
                { 9, new Vector3(139.6844, -702.78125, 33.155108)}, //FIB
                { 10, new Vector3(1390.9471, 1156.9696, 114.52328)}, //La Cosa Nostra
                { 11, new Vector3(-114.58606, 988.9835, 235.28635)}, //Russian Mafia
                { 12, new Vector3(-1007.8333, 298.06314, 68.42086)}, //Yakuza Mafia
                { 13, new Vector3(-1539.4457, 119.47098, 56.77987)}, //Armenian Mafia
                { 14, new Vector3(-2336.9888, 3314.033, 31.70962)}, //Army
                { 15, new Vector3(-568.05597, -909.9288, 22.757114)}, //News
                { 16, new Vector3(0,0,0)}, //The Lost
                { 17, new Vector3(0,0,0)}, //Merryweather Security
                { 18, new Vector3(-459.43457, 6031.523, 31.420525)}, //Sheriff
            };
