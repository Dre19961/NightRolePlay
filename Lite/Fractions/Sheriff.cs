    ...
    class Sheriff : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel("~w~Sheriff's Officer", new Vector3(-455.9738, 6014.119, 32.59654), 5f, 0.4f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension); // Режим ЧП
                NAPI.TextLabel.CreateTextLabel("~w~Sheriff's Secretary", new Vector3(-449.8658, 6012.458, 32.59655), 5f, 0.4f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension); // в здании за стойков на входе
                NAPI.TextLabel.CreateTextLabel("~w~Sheriff's Officer", new Vector3(-429.0482, 5997.3, 32.59655), 5f, 0.4f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension); // Оружейный склад
