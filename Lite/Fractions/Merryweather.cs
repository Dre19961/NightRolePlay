...
namespace Lite.Fractions
{
    class Merryweather : Script
    {
        ...
        {
            new Vector3(-144.57738, -577.6876, 31.304525), // Колшэйп входа в бункер   0
            ...
            new Vector3(2106.29, 2931.6814, -63.521942),  // open stock     3
             new Vector3(2111.3254, 2928.186, -63.521942),  // open stock     3
        };
        ...
        public void OnResourceStartHandler()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~g~Открыть склад"), new Vector3(Coords[4].X, Coords[4].Y, Coords[4].Z + 1.8), 5F, 0.3F, 0, new Color(250, 250, 250));
