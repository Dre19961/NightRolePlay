...
namespace Lite.Fractions
{
    class Cityhall : Script
    {
        ...
        public void OnResourceStartHandler()
        {
            try
            {
                ...
                for (int i = 2; i < 4; i++)
                {
                    ...
                    NAPI.Marker.CreateMarker(21, CityhallChecksCoords[i] + new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.8f, new Color(255, 255, 255, 0));
                }
                /*int door = 0;
                for (int i = 4; i < 6; i++)
                {
                ...
                NAPI.Marker.CreateMarker(1, CityhallChecksCoords[0] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1, new Color(129, 159, 235));
                NAPI.Marker.CreateMarker(1, CityhallChecksCoords[1] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1, new Color(129, 159, 235));
                NAPI.Marker.CreateMarker(1, CityhallChecksCoords[6] - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1, new Color(129, 159, 235));
        ...
        {
            new Vector3(-549.8379, -181.46762, 42.700665), // оружейка в мэрии 0z
            new Vector3(-546.98065, -185.94925, 42.70233), // раздевалка в мэрии
            new Vector3(-545.0524, -204.0801, 0.09514), // main door enter
            new Vector3(233.312, 216.0169, 0), // main door exit
            new Vector3(256.9124, 220.4567, 105.2864), // door 1
            new Vector3(265.8495, 218.1592, 109.283), // door 2
            new Vector3(-548.0037, -180.45555, 42.70073), // gun stock 6
        };
