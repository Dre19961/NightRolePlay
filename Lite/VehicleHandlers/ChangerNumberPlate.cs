...
namespace Lite.VehicleHandlers
{
    class ChangerNumberPlate : Script
    {
        ...
        private static Vector3 Changenum = new Vector3(407.78766, -1005.3009, 28.645983);
        ...
        public static void onResourceStart()
        {
            try
            {
                ...
                intmarker = NAPI.Marker.CreateMarker(1, Changenum - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1.5f, new Color(35, 152, 247), false, 0);
                shape = NAPI.ColShape.CreateCylinderColShape(Changenum, 1.5f, 3, 0);
                lable = NAPI.TextLabel.CreateTextLabel("~b~Смена номеров", Changenum + new Vector3(0, 0, 0.4), 5F, 0.3F, 0, new Color(255, 255, 255), true, 0);
                NAPI.TextLabel.CreateTextLabel("~w~Цена: 25.000~g~$", Changenum + new Vector3(0, 0, 0.2), 5f, 0.3f, 0, new Color(255, 255, 255), true, 0);
