...
namespace Lite.VehicleHandlers
{
    class SpeedChecker : Script
    {
        ...
        private static GTANetworkAPI.Vector3 _paycords = new Vector3(447.72098, -987.39215, 30.069593);
        ...
        public static void onResourceStart()
        {
            for (int i = 0; i < CameraPosition.Count; i++)
            {
                ...
                NAPI.Blip.CreateBlip(629, CameraPosition[i], 0.5f, 4, Main.StringToU16("Камера"), 150, 10, true, 0, 0);
            ...
            _ShapePolicePay = NAPI.ColShape.CreateCylinderColShape(_paycords, 0.5f, 2, 0);
            NAPI.Marker.CreateMarker(1, _paycords - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.5f, new Color(35, 152, 247), false, 0);
            NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~b~Оплата штрафов"), _paycords + new Vector3(0, 0, 0.2), 5f, 0.3f, 0,  new Color(255, 255, 255), true, 0);
