...
namespace Lite.Houses
{
    class AutoSelltoGov : Script
    {
        ...
        private static Vector3 _position = new Vector3(2395.0818, 3102.7214, 47.031754);
        ...
        public void onResourceStart()
        {
            try
            {
                NAPI.Marker.CreateMarker(1, _position - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.5f, new Color(66, 170, 255));
                NAPI.Blip.CreateBlip(527, _position, 1f, 84, "Свалка", 255, 0, true, 0, 0);
                _shape = NAPI.ColShape.CreateCylinderColShape(_position, 0.5f, 2, 0);
