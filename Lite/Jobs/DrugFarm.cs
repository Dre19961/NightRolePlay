...
namespace Lite.Jobs
{
    class DrugFarm : Script
    {
        ...
        private static int _drugsPayment = 400;  //статичная цена
        ...
        private static int _maxMultiplier = 3; // максимальный коеффициеннт
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                Cols.Add(1, NAPI.ColShape.CreateCylinderColShape(new Vector3(2931.4307, 4624.773, 47.603603), 0.5f, 2, 0)); // get clothes
                NAPI.Marker.CreateMarker(1, new Vector3(2931.4307, 4624.773, 47.603603), new Vector3(), new Vector3(), 0.5f, new Color(129, 159, 235, 255));
                ...
                Cols.Add(2, NAPI.ColShape.CreateCylinderColShape(new Vector3(-1897.205, 2079.9526, 139.87746), 0.5f, 2, 0)); // drug seller
                NAPI.Marker.CreateMarker(1, new Vector3(2931.4307, 4624.773, 47.603603), new Vector3(), new Vector3(), 0.5f, new Color(129, 159, 235, 255));
