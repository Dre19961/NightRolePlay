...
namespace Lite.Jobs
{
    class Collector : Script
    {
        ...
        private static int checkpointPayment = 10000;
        ...
        public void Event_ResourceStart()
        {
            try
            {
                ...
                NAPI.Marker.CreateMarker(1, TakeMoneyPos - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1, new Color(129, 159, 235), false, 0);
