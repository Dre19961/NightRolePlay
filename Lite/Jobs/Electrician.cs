...
namespace Lite.Jobs
{
    ...
    {
        private static int checkpointPayment = 700;
        ...
        public void Event_ResourceStart()
        {
            try
            {
                ...
                NAPI.Marker.CreateMarker(1, new Vector3(724.9625, 133.9959, 79.83643) - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1, new Color(129, 159, 235));
        ...
        private static void PlayerEnterCheckpoint(ColShape shape, Player player)
        {
            try
            {
                ...
                player.PlayAnimation("amb@prop_human_movie_studio_light@base", "base", 47); //39
