    ...
    class Gopostal : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16(""), Coords[0] + new Vector3(0, 0, 0.3), 10F, 0.6F, 0, new Color(67, 140, 239));
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("Взять машину"), Coords[1] + new Vector3(0, 0, 0.3), 10F, 0.6F, 4, new Color(255, 255, 255));

            }
            catch (Exception e) { Log.Write("ResourceStart: " + e.Message, nLog.Type.Error); }
        }

        private static int checkpointPayment = 50;

        public static List<Vector3> Coords = new List<Vector3>()
        {
            new Vector3(-261.13257, -904.2704, 31.190805), // start work
            new Vector3(-283.05353, -914.9389, 31.481892), // get car
        };
        ...
        public static void getGoPostalCar(Player player)
        {
            ...
            var veh = API.Shared.CreateVehicle(VehicleHash.Boxville2, player.Position + new Vector3(0, 0, 1), player.Rotation.Z, 134, 73);
