...
namespace Lite
{
    public class CarMarket : Script
    {
        ...
        // internal static Dictionary<int, Dictionary<int, Core.VehicleManager.VehicleCustomization> Custom = new Dictionary<int, Dictionary<int, Core.VehicleManager.VehicleCustomization>();
        internal static Dictionary<string, Core.VehicleManager.VehicleCustomization> Custom = new Dictionary<string, Core.VehicleManager.VehicleCustomization>();
        ...
        public void RemoveFromBazar(Player player, string number)
        {
            ...
            foreach (DataRow Row in resultt.Rows)
            {
                ...
                CarMarket.CreateBazarVeh(target_name, CarMarketCar.Model, CarMarketCar.Number);
                Core.VehicleManager.VehicleCustomization datatun = Custom[CarMarketCar.Number];

                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Muffler = datatun.Muffler;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.SideSkirt = datatun.SideSkirt;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Hood = datatun.Hood;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Spoiler = datatun.Spoiler;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Lattice = datatun.Lattice;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Wings = datatun.Wings;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Roof = datatun.Roof;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Vinyls = datatun.Vinyls;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.FrontBumper = datatun.FrontBumper;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.RearBumper = datatun.RearBumper;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Engine = datatun.Engine;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Turbo = datatun.Turbo;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Horn = datatun.Horn;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Transmission = datatun.Transmission;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.WindowTint = datatun.WindowTint;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Suspension = datatun.Suspension;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Brakes = datatun.Brakes;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Headlights = datatun.Headlights;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.NumberPlate = datatun.NumberPlate;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.Wheels = datatun.Wheels;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.WheelsType = datatun.WheelsType;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.PrimColor = datatun.PrimColor;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.SecColor = datatun.SecColor;
                Core.VehicleManager.Vehicles[CarMarketCar.Number].Components.NeonColor = datatun.NeonColor;

                Core.VehicleManager.VehicleData datacomp = Core.VehicleManager.Vehicles[CarMarketCar.Number];
            ...
            public void OpenBazar(Player player)
            {
                ...
                foreach (DataRow Row in resultt.Rows)
                {
                    ...
                    Core.VehicleManager.VehicleCustomization datatun = Custom[data.Number];
            ...
            {
                NAPI.Blip.CreateBlip(490, new Vector3(-601.0428, -2228.1235, 4.9709), 0.8f, 0, Main.StringToU16("Автобазар"), 255, 0, true, 0, 0); // Блип на карте
                ...
                foreach (DataRow Row in resultt.Rows)
                {
                    ...
                    Cars data = new Cars
                    {
                        ...
                        Model = Convert.ToString(Row["model"]),
                        Number = Convert.ToString(Row["number"]),
                        Tuning = JsonConvert.DeserializeObject<Core.VehicleManager.VehicleCustomization>((string)Row["tuning"]),
                        Price = Convert.ToInt32(Row["price"]),
                        Holder = Convert.ToInt32(Row["holder"]),
                    };
            ...
            {
                Core.VehicleManager.VehicleData data = new Core.VehicleManager.VehicleData();
                data.Holder = Holder;
                data.Model = Model;
                data.Health = Health;
                data.Fuel = Fuel;
                data.Price = Price;
                data.Components = new Core.VehicleManager.VehicleCustomization();
                data.Items = new List<nItem>();
                data.Dirt = 0.0F;

                Core.VehicleManager.Vehicles.Add(Number, data);
    ...
    public class Cars
    {
        ...
        internal Core.VehicleManager.VehicleCustomization Tuning { get; set; }
    }
