    ...
    class DrivingSchool : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.Marker.CreateMarker(1, enterSchool - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1, new Color(129, 159, 235));
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~g~Инструктор"), new Vector3(enterSchool.X, enterSchool.Y, enterSchool.Z + 2.25f), 5f, 0.3f, 0, new Color(255, 255, 255));
