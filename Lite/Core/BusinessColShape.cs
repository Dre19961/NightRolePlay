...
namespace Lite.Core
{
    ...
    public class BusinessColShape
    {
        ...
        [JsonIgnore]
        private TextLabel label_info = null;*/
        ...
        public void CreateColShape()
        {
            ...
            intMarker = NAPI.Marker.CreateMarker(29, new Vector3(Position.X, Position.Y, Position.Z + 0.5) - new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 1f, new Color(255, 255, 255, 220), false, (uint)Dimension);
