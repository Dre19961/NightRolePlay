        ...
        public static int CreateFamilies(Player player, string name, int maxpl, string img)
        {
            try
            {
                ...
                MySqlCommand queryCommand = new MySqlCommand(@"
                    INSERT INTO `family`(`cid`, `name`, `house`, `maxplayers`, `leader`, `imgurl`, `vehicles`, `money`, `comp`, `desc_1`, `desc_2`, `updates`)
                    VALUES
                    (@CID, @NAME, @HOUSE, @MAXPLAYERS, @LEADER, @IMGURL, @VEHICLES, @MONEY, @COMP, @DESC_1, @DESC_2, @UPDATES)
                ");

                queryCommand.Parameters.AddWithValue("@CID", cid);
                queryCommand.Parameters.AddWithValue("@NAME", familyname);
                queryCommand.Parameters.AddWithValue("@HOUSE", house);
                queryCommand.Parameters.AddWithValue("@MAXPLAYERS", maxplayers);
                queryCommand.Parameters.AddWithValue("@LEADER", leader);
                queryCommand.Parameters.AddWithValue("@IMGURL", imgurl);
                queryCommand.Parameters.AddWithValue("@VEHICLES", Newtonsoft.Json.JsonConvert.SerializeObject(data.Vehicles));
                queryCommand.Parameters.AddWithValue("@MONEY", 0);
                queryCommand.Parameters.AddWithValue("@COMP", 0);
                queryCommand.Parameters.AddWithValue("@DESC_1", "");
                queryCommand.Parameters.AddWithValue("@DESC_2", "");
                queryCommand.Parameters.AddWithValue("@UPDATES", null);
                ...
                pHouse.blip = blip;
                Lite.MoneySystem.Wallet.Change(player, -price);
