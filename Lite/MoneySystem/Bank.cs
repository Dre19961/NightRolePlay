    ...
    class ATM : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                {
                    if (i != 58) NAPI.Blip.CreateBlip(500, ATMs[i], 0.35f, 69, "Банкомат", shortRange: true, dimension: 0);
            ...
            try
            {
                ...
                switch (type)
                {
                    ...
                    case 2:
                        ...
                        var maxMoney = Convert.ToInt32(house.Price / 100 * 0.013) * 24 * 3;
                        ...
                        Trigger.ClientEvent(player,
                                "atmOpen", $"[2,'{Bank.Accounts[house.BankID].Balance}/{Convert.ToInt32(house.Price / 100 * 0.013) * 24 * 3}$','Сумма внесения наличных']");
                        break;
                    case 3:
